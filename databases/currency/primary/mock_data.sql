...
('bundle_arrowEUR', 'EUR', 'Stand Arrow Bundle', 1000, 9.99),
('bundle_requiemEUR', 'EUR', 'Requiem Arrow Bundle', 3000, 24.99),
('bundle_heavenEUR', 'EUR', 'Heaven\'s Bundle', 5000, 49.99),
('bundle_arrowUSD', 'USD', 'Stand Arrow Bundle', 1000, 10.99),
('bundle_requiemUSD', 'USD', 'Requiem Arrow Bundle', 3000, 27.99),
('bundle_heavenUSD', 'USD', 'Heaven\'s Bundle', 5000, 54.99);
...
('bundle_arrowEUR', 'EUR', UNHEX(REPLACE('e3b0c442-98fc-1c14-b39f-92d1282048c0', '-', '')), '2024-01-05 10:00:00'),
('bundle_heavenUSD', 'USD', UNHEX(REPLACE('87f3b5d1-5e8e-4fa4-909b-3cd29f4b1f09', '-', '')), '2024-01-06 11:30:00'),
('bundle_requiemEUR', 'EUR', UNHEX(REPLACE('a4f0c592-12af-4bde-aacd-94cd0f27c57e', '-', '')), '2024-01-07 15:45:00');
