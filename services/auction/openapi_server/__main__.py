...
def main():
    ...
    flask_app.config["DB_CONFIG"] = {
        ...
        "ssl_cert": "/usr/src/app/ssl/auction-cert.pem",
        "ssl_key": "/usr/src/app/ssl/auction-key.pem",
    }
    ...
    connexion_app.run(
        ...
        port=443,
        debug=True,
        ssl_context=("/usr/src/app/ssl/auction-cert.pem", "/usr/src/app/ssl/auction-key.pem"),
    )
