...
MOCK_GACHAS = {
    '1b2f7b4e-5e1f-4112-a7c5-b7559dbb8c76': ('Star Platinum', 'LEGENDARY', 100, 100, 100, 100, 60, 100, datetime.date(2024, 1, 1)),
    '9d4b9fa9-6c72-44f5-9ac6-e6b548cfc632': ('The World', 'LEGENDARY', 100, 100, 100, 100, 60, 100, datetime.date(2024, 1, 2)),
    'b6e7f8c9-7f28-4b4f-8fbe-523f6c8b0c85': ('Gold Experience', 'EPIC', 80, 80, 80, 80, 60, 100, datetime.date(2024, 1, 3)),
    '8f2b9d4e-3b3e-4c5d-a1c6-b7e3a5d6c1c7': ('Crazy Diamond', 'EPIC', 100, 100, 80, 100, 40, 80, datetime.date(2024, 1, 4)),
    'c1d2e3f4-5a6b-7c8d-9e0f-1a2b3c4d5e6f': ('Silver Chariot', 'RARE', 80, 100, 60, 100, 60, 60, datetime.date(2024, 1, 5)),
    'd4e5f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a': ('Hermit Purple', 'COMMON', 40, 60, 60, 80, 80, 40, datetime.date(2024, 1, 6)),
    'e7f8a9b0-c1d2-3e4f-5a6b-7c8d9e0f1a2b': ('Magicians Red', 'RARE', 80, 60, 60, 60, 80, 60, datetime.date(2024, 1, 7)),
    'f1a2b3c4-d5e6-f7a8-b9c0-1d2e3f4a5b6c': ('Hierophant Green', 'RARE', 60, 60, 60, 100, 100, 60, datetime.date(2024, 1, 8)),
    'a1b2c3d4-e5f6-7890-1234-567890abcdef': ('King Crimson', 'LEGENDARY', 100, 80, 80, 80, 40, 100, datetime.date(2024, 1, 9)),
    'b2c3d4e5-f6a7-8901-2345-67890abcdef1': ('Killer Queen', 'EPIC', 80, 80, 80, 100, 60, 80, datetime.date(2024, 1, 10)),
    'c3d4e5f6-a7b8-9012-3456-7890abcdef12': ('Made in Heaven', 'LEGENDARY', 100, 100, 100, 100, 100, 100, datetime.date(2024, 1, 11)),
    'd4e5f6a7-b8c9-0123-4567-890abcdef123': ('Sticky Fingers', 'RARE', 80, 80, 60, 80, 40, 60, datetime.date(2024, 1, 12)),
    'e5f6a7b8-c9d0-1234-5678-90abcdef1234': ('Purple Haze', 'EPIC', 100, 60, 60, 40, 40, 40, datetime.date(2024, 1, 13)),
    'f6a7b8c9-d0e1-2345-6789-0abcdef12345': ('Sex Pistols', 'RARE', 40, 60, 80, 100, 100, 40, datetime.date(2024, 1, 14)),
    'a7b8c9d0-e1f2-3456-7890-abcdef123456': ('Aerosmith', 'RARE', 60, 80, 60, 80, 100, 40, datetime.date(2024, 1, 15)),
    'b8c9d0e1-f2a3-4567-8901-bcdef1234567': ('Moody Blues', 'RARE', 40, 60, 60, 100, 40, 60, datetime.date(2024, 1, 16)),
    'c9d0e1f2-a3b4-5678-9012-cdef12345678': ('Beach Boy', 'COMMON', 20, 40, 60, 100, 100, 40, datetime.date(2024, 1, 17)),
    'd0e1f2a3-b4c5-6789-0123-def123456789': ('White Album', 'RARE', 60, 60, 100, 60, 40, 60, datetime.date(2024, 1, 18)),
    'e1f2a3b4-c5d6-7890-1234-ef123456789a': ('Stone Free', 'EPIC', 80, 80, 80, 100, 60, 80, datetime.date(2024, 1, 19)),
    'f2a3b4c5-d6e7-8901-2345-f123456789ab': ('Weather Report', 'EPIC', 80, 60, 80, 80, 80, 100, datetime.date(2024, 1, 20)),
    'a3b4c5d6-e7f8-9012-3456-123456789abc': ('D4C', 'LEGENDARY', 100, 80, 100, 80, 60, 100, datetime.date(2024, 1, 21)),
    'b4c5d6e7-f8a9-0123-4567-23456789abcd': ('Tusk Act 4', 'LEGENDARY', 100, 60, 100, 80, 60, 100, datetime.date(2024, 1, 22)),
    'c5d6e7f8-a9b0-1234-5678-3456789abcde': ('Soft & Wet', 'EPIC', 80, 80, 80, 100, 40, 100, datetime.date(2024, 1, 23)),
}
...
MOCK_POOL_ITEMS = {
    'pool_joestar': ['1b2f7b4e-5e1f-4112-a7c5-b7559dbb8c76', 'd4e5f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a', '8f2b9d4e-3b3e-4c5d-a1c6-b7e3a5d6c1c7', 'e1f2a3b4-c5d6-7890-1234-ef123456789a', 'b4c5d6e7-f8a9-0123-4567-23456789abcd', 'c5d6e7f8-a9b0-1234-5678-3456789abcde'],
    'pool_passione': ['b6e7f8c9-7f28-4b4f-8fbe-523f6c8b0c85', 'd4e5f6a7-b8c9-0123-4567-890abcdef123', 'e5f6a7b8-c9d0-1234-5678-90abcdef1234', 'f6a7b8c9-d0e1-2345-6789-0abcdef12345', 'a7b8c9d0-e1f2-3456-7890-abcdef123456', 'b8c9d0e1-f2a3-4567-8901-bcdef1234567'],
    'pool_duwang': ['8f2b9d4e-3b3e-4c5d-a1c6-b7e3a5d6c1c7', 'b2c3d4e5-f6a7-8901-2345-67890abcdef1', 'c9d0e1f2-a3b4-5678-9012-cdef12345678', 'd0e1f2a3-b4c5-6789-0123-def123456789'],
    'pool_pucci': ['9d4b9fa9-6c72-44f5-9ac6-e6b548cfc632', 'c3d4e5f6-a7b8-9012-3456-7890abcdef12', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', 'f2a3b4c5-d6e7-8901-2345-f123456789ab'],
    'pool_valentine': ['a3b4c5d6-e7f8-9012-3456-123456789abc', 'b4c5d6e7-f8a9-0123-4567-23456789abcd', 'c1d2e3f4-5a6b-7c8d-9e0f-1a2b3c4d5e6f', 'e7f8a9b0-c1d2-3e4f-5a6b-7c8d9e0f1a2b']
}
...
def create_gacha(gacha=None, session=None):
    ...
    try:
        ...
        def insert_gacha():
            ...
            stats = {stat: 120 - (ord(getattr(gacha_data.attributes, stat).upper()) - ord('A')) * 20 for stat in ["power", "speed", "durability", "precision", "range", "potential"]}
    ...
    except (OperationalError, DataError, ProgrammingError, InternalError, InterfaceError, DatabaseError): # other potential errors
        return "", 503
...
def create_pool(pool=None, session=None):
    ...
    try:
        ...
        def insert_pool():
            ...
            MOCK_POOLS[codename] = (pool_data.public_name, pool_data.probability_common, pool_data.probability_rare, pool_data.probability_epic, pool_data.probability_legendary, pool_data.price)
    ...
    except (OperationalError, DataError, DatabaseError, IntegrityError, InterfaceError, InternalError, ProgrammingError):
        return "", 503
    except CircuitBreakerError:
        return "", 503
...
def get_gacha(session=None, uuid=None):
    ...
    try:
        ...
        def get_gacha_from_db():
            ...
            name, rarity, power, speed, durability, precision, range_, potential, release_date = gacha_data  # Unpack tuple
...
def update_gacha(gacha=None, session=None):
    ...
    try:
        ...
        def update_gacha_in_db():
            ...
            current_name, current_rarity, current_power, current_speed, current_durability, current_precision, current_range, current_potential, current_release_date = MOCK_GACHAS[uuid]


            stats = {stat: 120 - (ord(getattr(gacha_obj.attributes, stat).upper()) - ord('A')) * 20 for stat in ["power", "speed", "durability", "precision", "range", "potential"]}


            # Check if values have changed (compare stats and rarity, skip name and release date)
            if (gacha_obj.rarity.upper() == current_rarity and
                stats['power'] == current_power and
                stats['speed'] == current_speed and
                stats['durability'] == current_durability and
                stats['precision'] == current_precision and
                stats['range'] == current_range and
                stats['potential'] == current_potential):
                return "", 304  # Not Modified



            MOCK_GACHAS[uuid] = (gacha_obj.name, gacha_obj.rarity.upper(), *stats.values(), current_release_date) # Update with corrected stats conversion and preserve release_date
...
def update_pool(pool=None, session=None):
    ...
    try:
        ...
        total_prob = (pool_obj.probability_common +
        ...
        def update_pool_in_db():
            ...
            if (pool_obj.public_name == current_pool[0] and
                pool_obj.probability_common == current_pool[1] and
                pool_obj.probability_rare == current_pool[2] and
                pool_obj.probability_epic == current_pool[3] and
                pool_obj.probability_legendary == current_pool[4] and
                price == current_pool[5]): 
            ...
            MOCK_POOLS[codename] = (pool_obj.public_name, pool_obj.probability_common, pool_obj.probability_rare, pool_obj.probability_epic, pool_obj.probability_legendary, price) # Use price here as well
