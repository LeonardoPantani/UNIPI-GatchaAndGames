...
MOCK_FEEDBACKS = {
    ("e3b0c44298fc1c14b39f92d1282048c0", "2024-01-10 12:00:00"): (
        "Yare yare daze... Great game!",
        "2024-01-10 12:00:00",
    ),
    ("87f3b5d15e8e4fa4909b3cd29f4b1f09", "2024-01-11 13:30:00"): (
        "WRYYYYY! Amazing stands!",
        "2024-01-11 13:30:00",
    ),
    ("a4f0c59212af4bdeaacd94cd0f27c57e", "2024-01-12 15:45:00"): (
...
MOCK_BUNDLESTRANSACTIONS = {
    ("e3b0c44298fc1c14b39f92d1282048c0", "bundle_arrowEUR", "2024-01-05 10:00:00"): (
        "bundle_arrowEUR",
        "EUR",
        "e3b0c44298fc1c14b39f92d1282048c0",
        "2024-01-05 10:00:00",
    ),
    ("87f3b5d15e8e4fa4909b3cd29f4b1f09", "bundle_heavenUSD", "2024-01-06 11:30:00"): (
        "bundle_heavenUSD",
        "USD",
        "87f3b5d15e8e4fa4909b3cd29f4b1f09",
        "2024-01-06 11:30:00",
    ),
    ("a4f0c59212af4bdeaacd94cd0f27c57e", "bundle_requiemEUR", "2024-01-07 15:45:00"): (
        "bundle_requiemEUR",
        "EUR",
        "a4f0c59212af4bdeaacd94cd0f27c57e",
        "2024-01-07 15:45:00",
...
MOCK_INGAMETRANSACTIONS = {
    ("e3b0c44298fc1c14b39f92d1282048c0", "2024-01-05 10:00:00"): (
        "e3b0c44298fc1c14b39f92d1282048c0",
        1000,
        "bought_bundle",
        "2024-01-05 10:00:00",
    ),
    ("87f3b5d15e8e4fa4909b3cd29f4b1f09", "2024-01-06 11:30:00"): (
        "87f3b5d15e8e4fa4909b3cd29f4b1f09",
        5000,
        "bought_bundle",
        "2024-01-06 11:30:00",
    ),
    ("a4f0c59212af4bdeaacd94cd0f27c57e", "2024-01-07 15:45:00"): (
        "a4f0c59212af4bdeaacd94cd0f27c57e",
        3000,
        "bought_bundle",
        "2024-01-07 15:45:00",
    ),
    ("e3b0c44298fc1c14b39f92d1282048c0", "2024-01-08 09:15:00"): (
        "e3b0c44298fc1c14b39f92d1282048c0",
        -1000,
        "gacha_pull",
        "2024-01-08 09:15:00",
    ),
    ("87f3b5d15e8e4fa4909b3cd29f4b1f09", "2024-01-09 14:20:00"): (
        "87f3b5d15e8e4fa4909b3cd29f4b1f09",
        -1200,
        "gacha_pull",
        "2024-01-09 14:20:00",
...
MOCK_INVENTORIES = {
    "f7e6d5c4b3a291807654321098fedcba": (
        "e3b0c44298fc1c14b39f92d1282048c0",
        "1b2f7b4e5e1f4112a7c5b7559dbb8c76",
        "2024-01-01",
        1,
        3000,
    ),
    "e6d5c4b3a29180765432109876fedcba": (
        "87f3b5d15e8e4fa4909b3cd29f4b1f09",
        "9d4b9fa96c7244f59ac6e6b548cfc632",
        "2024-01-02",
        1,
        3000,
    ),
    "d5c4b3a29180765432109876fedcba98": (
        "a4f0c59212af4bdeaacd94cd0f27c57e",
        "b6e7f8c97f284b4f8fbe523f6c8b0c85",
        "2024-01-03",
        1,
        2500,
    ),
    ...
    "b7a6c5d4e3f210987654fedcba987655": (
        "4f2e8bb538e145379cfa11425c3b4284",
        "9d4b9fa96c7244f59ac6e6b548cfc632",
        "2024-01-02",
        1,
    ...
    "a7b6c5d4e3f210987654fedcba987656": (
        "4f2e8bb538e145379cfa11425c3b4284",
        "b6e7f8c97f284b4f8fbe523f6c8b0c85",
        "2024-01-03",
        1,
    ...
    "97b6c5d4e3f210987654fedcba987657": (
        "4f2e8bb538e145379cfa11425c3b4284",
        "8f2b9d4e3b3e4c5da1c6b7e3a5d6c1c7",
        "2024-01-04",
        1,
        3000,
    ),
    "87b6c5d4e3f210987654fedcba987658": (
        "4f2e8bb538e145379cfa11425c3b4284",
        "c1d2e3f45a6b7c8d9e0f1a2b3c4d5e6f",
        "2024-01-05",
        1,
        2000,
    ),
    "77b6c5d4e3f210987654fedcba987659": (
        "4f2e8bb538e145379cfa11425c3b4284",
        "d4e5f6a7b8c90d1e2f3a4b5c6d7e8f9a",
        "2024-01-06",
        1,
        1000,
    ),
    "67b6c5d4e3f210987654fedcba987660": (
        "4f2e8bb538e145379cfa11425c3b4284",
        "e7f8a9b0c1d23e4f5a6b7c8d9e0f1a2b",
        "2024-01-07",
        1,
        2000,
    ),
    "57b6c5d4e3f210987654fedcba987661": (
        "a1a2a3a4b5b6c7c8d9d0e1e2e3e4e5e6",
        "c3d4e5f6a7b8901234567890abcdef12",
        "2024-01-08",
        1,
        5000,
    ),
    "47b6c5d4e3f210987654fedcba987662": (
        "a1a2a3a4b5b6c7c8d9d0e1e2e3e4e5e6",
    ...
    "37b6c5d4e3f210987654fedcba987663": (
        "a1a2a3a4b5b6c7c8d9d0e1e2e3e4e5e6",
    ...
    "27b6c5d4e3f210987654fedcba987664": (
        "a1a2a3a4b5b6c7c8d9d0e1e2e3e4e5e6",
        "e5f6a7b8c9d01234567890abcdef1234",
        "2024-01-11",
        1,
        3000,
    ),
    "17b6c5d4e3f210987654fedcba987665": (
        "a1a2a3a4b5b6c7c8d9d0e1e2e3e4e5e6",
        "f6a7b8c9d0e1234567890abcdef12345",
        "2024-01-12",
        1,
        2000,
    ),
    "07b6c5d4e3f210987654fedcba987666": (
        "a1a2a3a4b5b6c7c8d9d0e1e2e3e4e5e6",
        "c9d0e1f2a3b456789012cdef12345678",
        "2024-01-13",
        1,
        1000,
    ),
    "f6b6c5d4e3f210987654fedcba987667": (
        "a1a2a3a4b5b6c7c8d9d0e1e2e3e4e5e6",
        "a7b8c9d0e1f234567890abcdef123456",
        "2024-01-14",
        1,
        2000,
    ),
...
MOCK_PROFILES = {
    ...
    "87f3b5d15e8e4fa4909b3cd29f4b1f09": ("DIOBrando", 6000, 95, "2024-01-05 11:00:00"),
    "a4f0c59212af4bdeaacd94cd0f27c57e": (
        "GiornoGiovanna",
        4500,
        85,
...
MOCK_PVPMATCHES = {
    ...
    "b2c3d4e5f6a78901bcdef12345678901": (
        "a4f0c59212af4bdeaacd94cd0f27c57e" "87f3b5d15e8e4fa4909b3cd29f4b1f09",
        True,
        {
            "match": {
...
def get_currency_from_uuid(session=None, user_uuid=None):
    if not user_uuid or not isinstance(user_uuid, str):
        return "", 400
    user_uuid = "".join(char for char in user_uuid if char not in string.punctuation)
